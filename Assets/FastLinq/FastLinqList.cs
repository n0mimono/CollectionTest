...
namespace Custom.Linq.Fast {
	public static partial class FastLinq {
		#region Aggregate
		public static TAccumulate Aggregate<TSource, TAccumulate> (this IList<TSource> source,
		...
		#region Average
		public static float Average (this IList<float> source) {
			float total = 0;
		...
		public static float Average<TSource> (this IList<TSource> source, Func<TSource, float> selector)
		{
			float total = 0;
		...
		#region Count
		public static int Count<TSource> (this IList<TSource> source)
		{
			return source.Count;
		}
		...
		public static TSource ElementAtOrDefault<TSource> (this IList<TSource> source, int index)
		{
			if (index < 0)
		...
		public static int Min<TSource> (this IList<TSource> source, Func<TSource, int> selector)
		{
			var max = int.MaxValue;
		...
		public static int Sum<TSource> (this IList<TSource> source, Func<TSource, int> selector)
		{
			int total = 0;
		...
		public static float Sum<TSource> (this IList<TSource> source, Func<TSource, float> selector)
		{
			float total = 0f;
